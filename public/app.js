...
function calculateLaborFromData(data) {
  ...
  const items = [
    { name: 'Labor - Squares', quantity: parseFloat(squaresWithWaste.toFixed(2)), unit: 'SQ', unitPrice: baseRate, total: squaresWithWaste * baseRate, editable: false },
    { name: 'Starter per Bundle', quantity: parseFloat(starterBundles.toFixed(2)), unit: 'BD', unitPrice: 25.00, total: starterBundles * 25.00, editable: false },
    { name: 'Hip and Ridge Cap per Bundle', quantity: parseFloat(hipRidgeBundles.toFixed(2)), unit: 'BD', unitPrice: 25.00, total: hipRidgeBundles * 25.00, editable: false },
    { name: 'Steep Charge for 8-9/12 pitch', quantity: parseFloat(pitchData.tier_8_9.toFixed(2)), unit: 'SQ', unitPrice: 5.00, total: pitchData.tier_8_9 * 5.00, editable: true },
    { name: 'Steep Charge for 10-11/12 pitch', quantity: parseFloat(pitchData.tier_10_11.toFixed(2)), unit: 'SQ', unitPrice: 10.00, total: pitchData.tier_10_11 * 10.00, editable: true },
    { name: 'Steep Charge for 12/12 pitch or Greater', quantity: parseFloat(pitchData.tier_12_plus.toFixed(2)), unit: 'SQ', unitPrice: 20.00, total: pitchData.tier_12_plus * 20.00, editable: true },
    { name: 'Plywood Replacement', quantity: parseFloat(plywoodSheets.toFixed(2)), unit: 'SH', unitPrice: plywoodPrice, total: plywoodSheets * plywoodPrice, editable: true },
    { name: 'Install Step Flashing per LF', quantity: parseFloat(stepFlashingLength.toFixed(2)), unit: 'LF', unitPrice: 2.00, total: stepFlashingLength * 2.00, editable: true },
    { name: 'Install L-Flashing per LF', quantity: parseFloat(flashingLength.toFixed(2)), unit: 'LF', unitPrice: 2.00, total: flashingLength * 2.00, editable: true },

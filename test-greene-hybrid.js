...
async function extractPdfText(dataBuffer) {
  ...
  const tempPdfPath = path.join('C:\\Users\\power\\Downloads', 'temp-greene.pdf');
...
async function processGreene() {
  try {
    ...
    fs.writeFileSync('C:\\Users\\power\\.openclaw\\workspace\\greene-ocr-full.txt', fullText);
    console.log('\nFull text saved to greene-ocr-full.txt');
